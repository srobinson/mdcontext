...
vi.mock('./storage.js', () => ({
  createStorage: (rootPath: string) => ({
    rootPath,
    paths: {
      root: `${rootPath}/.mdcontext`,
      config: `${rootPath}/.mdcontext/config.json`,
      documents: `${rootPath}/.mdcontext/indexes/documents.json`,
      sections: `${rootPath}/.mdcontext/indexes/sections.json`,
      links: `${rootPath}/.mdcontext/indexes/links.json`,
      cache: `${rootPath}/.mdcontext/cache`,
      parsed: `${rootPath}/.mdcontext/cache/parsed`,
    },
  }),
